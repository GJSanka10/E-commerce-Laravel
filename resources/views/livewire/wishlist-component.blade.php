                                    ...
                                    <div class="product-cart-wrap mb-30">
                                        ...
                                        <div class="product-content-wrap">
                                            ...
                                            <div class="product-action-1 show">
                                                <a wire:click.prevent="removeFromWishlist({{$item->model->id}})" aria-label="Remove From Wishlist" class="action-btn hover-up wishlisted" href="#" ><i class="fi-rs-heart"></i></a>
